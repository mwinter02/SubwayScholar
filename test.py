...
def main() -> None:
    ...
    parser.add_argument(
        "-pdf",
        dest="pdf_path",
        help="Path to input PDF for PyMuPDF-based PDF module test",
    )
    ...
    if args.pdf_path:
        from tests.test_pdf_module import run_pdf_module_test
    ...
    if args.llm_text_path:
        from tests.test_llm_module import run_llm_module_test
    ...
    if args.tts_text_path:
        from tests.test_tts_module import run_tts_module_test
    ...
    if args.video_args:
        ...
        from tests.test_video_module import run_video_module_test
